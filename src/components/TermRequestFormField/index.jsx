...
const Schema = yup.object({
    ...
    termName: yup.string().required("term name is required").typeError("valid input is required"),
    jobTitle: yup.string().required("job title is required").typeError("valid input is required"),
    endDate: yup.date().required("date is required").typeError("valid date is required"),
    workLocation: yup.string().required("work location is required").typeError("valid input is required"),
    termLocation: yup.string().required("work location is required").typeError("valid input is required"),
    termContact: yup.number().required("number is required").typeError("enter valid number only") , 
    ...
    computerCollect: yup.boolean().required("this is required"), 
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={classes.formBlock}>
            <div className={classes.formGroupRow}>
                ...
                <div className={classes.formGroup}>
                    <label htmlFor="" className={classes.label}>Term Name</label>
                    <Controller
                        name="termName"
                        control={control}
                        rules={{ required: true }}
                    ...
                    />
                    {errors.termName && <span className={classes.errors}>This is required.</span>}
                </div>
                <div className={classes.formGroup}>
                ...
                <div className={classes.formGroup}>
                    <label htmlFor="" className={classes.label}>End Date</label>
                    <Controller
                        name="endDate"
                        control={control}
                        rules={{ required: true }}
                    ...
                    />
                    {errors.endDate && <span className={classes.errors}>This is required.</span>}
                </div>
                <div className={classes.formGroup}>
                ...
                <div className={classes.formGroup}>
                    <label htmlFor="" className={classes.label}>Term Location Address</label>
                    <Controller
                        name="termLocation"
                        control={control}
                        rules={{ required: true }}
                    ...
                    />
                    {errors.termLocation && <span className={classes.errors}>This is required.</span>}
                </div> 
                <div className={classes.formGroup}>
                    <label htmlFor="" className={classes.label}>Term Contact</label>
                    <Controller
                        name="termContact"
                        control={control}
                        rules={{ required: true }}
                    ...
                    />
                    {errors.termContact && <span className={classes.errors}>This is required.</span>}
                </div>                 
                <div className={classes.formGroup}>
                ...
                <div className={classes.checkFieldGroup}>
                    ...
                    />
                    <label htmlFor="" className={classes.label} style={{marginBottom: '0px'}}>Computer Need to Collect?</label>
                    {errors.computerCollect && <span className={classes.errors}>This is required.</span>}
                </div>             
                <div className={classes.formGroup}>
