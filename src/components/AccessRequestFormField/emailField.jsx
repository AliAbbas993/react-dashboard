...
const FieldMap = [
    ...
    [
        ...
        {
            label: "Change Reason/Description"
        }
    ]
]
...
const EmailField = (props) => {
    ...
    const accessOptionChange = (e) => {
        setPayload({...payload , emailOpt:e})
    }
    const subMenuChange = (e) => {
        setEndFields(e)
        let fieldsClone = []
        setPayload({...payload , emailSubOpt:e , fields: [...fieldsClone]})
    }
    ...
    return (
        <>
            ...
            <div className={classes.formGroup}>
                <label htmlFor="" className={classes.label}>Email Sub Menu</label>
                <Select 
                    options={subMenu} 
