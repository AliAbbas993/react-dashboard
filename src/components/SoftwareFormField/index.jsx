...
const softwareOptions = [
    ...
    { value: 8, label: "Office 365 License" },
    { value: 9, label: "Yardi" },
    { value: 10, label: "Wellsky" },
    { value: 11, label: "MRI" },
    { value: 12, label: "Blackbaud" },
...
const Schema = yup.object({
    ...
    software: yup.object().required("this is required")
});


const SoftwareFormField = () => {
    const {
        register,
        handleSubmit,
        setValue,
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={classes.formBlock}>
            <div className={classes.formGroupRow}>
                ...
                <div className={classes.formGroup}>
                    <label htmlFor="" className={classes.label}>Software</label>
                    <Controller
                        name="software"
                        control={control}
                        rules={{ required: true }}
                    ...
                    />
                    {errors.software && <span className={classes.errors}>This is required.</span>}
                </div>
            </div>
            <div className={classes.formGroupRow} 
                style={{
...
export default SoftwareFormField;
