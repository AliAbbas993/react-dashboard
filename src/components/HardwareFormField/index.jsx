...
const hardwareOptions = [
    ...
    { value: 3, label: "Desk Phone" },
    { value: 4, label: "Cell Phone" },
    { value: 5, label: "Tablet" },
    { value: 6, label: "Time Clock" },
    { value: 7, label: "Monitor" },
    { value: 8, label: "Docking Station" },
    { value: 9, label: "other" }
];
...
const Schema = yup.object({
    ...
    hardware: yup.object().required("this is required")
});


const HardwareFormField = () => {
    const {
        register,
        handleSubmit,
        setValue,
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={classes.formBlock}>
            <div className={classes.formGroupRow}>
                ...
                <div className={classes.formGroup}>
                    <label htmlFor="" className={classes.label}>Hardware</label>
                    <Controller
                        name="hardware"
                        control={control}
                        rules={{ required: true }}
                    ...
                    />
                    {errors.hardware && <span className={classes.errors}>This is required.</span>}
                </div>
            </div>
            <div className={classes.formGroupRow} 
                style={{
...
export default HardwareFormField;
